...
const ADVANTAGES_LIST = [
  {
    ...
    icon: <RiNurseFill />,
    src: 'img/advantages/advantages-8.jpg'
  }, {
    id: 2,
    title: 'Развитая сеть поставщиков и партнеров',
    icon: <RiHandCoinFill />,
    src: 'img/advantages/advantages-4.jpg'
  }, {
    id: 3,
    ...
    icon: <RiFileTextFill />,
    src: 'img/advantages/advantages-3.jpg'
  }, {
    id: 6,
    title: 'Работа на тендерных площадках. Поддержка заказчиков в публикации закупок',
    icon: <RiLineChartFill />,
    src: 'img/advantages/advantages-7.jpg'
  }, {
    id: 7,
    title: 'Собственное конструкторское бюро',
    icon: <RiShipFill />,
    src: 'img/advantages/advantages-6.jpg'
  }, {
    id: 8,
    title: 'Собственное производство',
    icon: <RiNodeTree />,
    src: 'img/advantages/advantages-1.jpg'
  }
]
